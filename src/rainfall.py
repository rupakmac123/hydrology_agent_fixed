        ...
        for name, dist_info in distributions.items():
            ...
            try:
                ...
                if len(expected_freq) >= 2:
                    ddof = max(0, len(expected_freq) - 1 - 3)
